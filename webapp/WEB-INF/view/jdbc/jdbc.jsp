...
<%--<page:template>--%>
    <body>
        ...
        <c:url value="/jdbcInsert/logstring/{logstring}" var="jdbcInsert" />
        <c:url value="/jdbcSelectLogs" var="jdbcSelectLogs" />
        <c:url value="/jdbcDelete/user/{iduser}" var="jdbcDelete" />
        <c:url value="/jdbcUpdate/user/username/{username}/enabled/{enabled}" var="jdbcUpdate" />
