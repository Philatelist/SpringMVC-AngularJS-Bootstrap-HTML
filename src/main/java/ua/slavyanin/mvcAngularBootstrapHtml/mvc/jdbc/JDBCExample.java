package ua.slavyanin.mvcAngularBootstrapHtml.mvc.jdbc;
...
import ua.slavyanin.mvcAngularBootstrapHtml.mvc.bean.DBLog;
import ua.slavyanin.mvcAngularBootstrapHtml.mvc.bean.User;
...
/*Здесь нужно обратить внимание на начало класса и использование JdbcTemplate,
в конструктор которому передается dataSource, который мы указали в файле конфигурации.
С помощью jdbcTemplate можно выполнять CRUD (вставка, обновление, удаление) операции.*/
