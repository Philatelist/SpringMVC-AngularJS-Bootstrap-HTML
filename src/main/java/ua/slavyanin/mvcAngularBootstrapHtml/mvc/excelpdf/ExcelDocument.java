package ua.slavyanin.mvcAngularBootstrapHtml.mvc.excelpdf;
...
соответствующий документ, а так же контроллер, который будет обрабатывать
запросы от клиента. Дополнительно был создан класс-заглушка Cat чисто
для формирования таблиц. Описывать подробно классы не буду, т.к. все названия
методов и переменных показывают их назначение (pdfHeader, addCell и т.п.).
*/
